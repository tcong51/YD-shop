                ...
                <div class="grid__column-10">
                    ...
                    <div class="home-product">
                        <div class="grid__row">
                            <?php
                            $idSP = $_GET['id'];
                            $sql2 = "SELECT tenSP FROM `sanpham`WHERE maSP='$idSP'";
                            if ($result2 = $con->query($sql2)) {
                                if ($result2->num_rows > 0) {
                                    while ($row2 = $result2->fetch_assoc()) {
                                        // echo"<h3 class='name1' >".$row2['tenSP']."</h3>";
                                    }
                                }
                            }
                            ?>
                            ...
                            if ($result = $con->query($sql)) {
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {
                                        ...
                                        $id = $row['maSP'];
                                        echo '<div class="details__product">
                                                                <div class="details__product-img">
                                                                    <div class="details__product-imginto">
                                                                        <img src="' . $row['Hinh'] . '" alt="" class="details__product-img1">
                                                                    </div>
                                                                </div>
                                                                <div class="details__product-content">
                                                                    <div class="details__product-content-info">
                                                                        <div class="details__product-content-name">' . $row['tenSP'] . '
                                                                        </div>';
                            ?>
                                        <div class="details__product-content-price">
                                            <span class="details__product-content-price-current"><?php echo number_format($row['giaSP'], 0, ',', '.') . ' đ' ?></span>


                                        </div>
                            <?php
                                        echo '
                                                                        <div class="details__product-content-order">
                                                                            <button>
                                                                                <a href="#" onclick="insertItem(' . $id . ')" class="btn btn--normal auth-form__controls-back ">Thêm vào giỏ</a>
                                                                            </button>
                                                                            <a href="#" class="details__product-content-order-btn btn btn--primary" onclick="showModalPayinCart()">Đặt hàng</a>
                                                                        </div>
                                                                        
                                                                        <div class="details__product-content-description">
                                                                            <hr>
                                                                            <div class="details__product-content-description-text">MÔ TẢ</div>
                                                                            <hr>
                                                                            <div class="details__product-content-description-content">' . $row['motaSP'] . '
                                                                            </div>
                                                                        </div>
                                    ...
                                    if ($result3->num_rows > 0) {
                                        while ($row2 = $result3->fetch_assoc()) {
                                            ...
                                            <a class="home-product-item" href="product.php?id=' . $id . '"> 
                                                <div class="home-product-item__img" style="background-image: url(' . $row2['Hinh'] . ');"></div>
                                                <h4 class="home-product-item__name">' . $row2['tenSP'] . '</h4>';
                                ?>
                                            <div class="home-product-item__price">


                                                <span class="home-product-item__price-current"><?php echo number_format($row2['giaSP'], 0, ',', '.') . ' đ' ?></span>
                        ...
                        <div class="comment_tilte">Bình luận </h5>

                            <?php
                            $idbl = $_GET['id'];
                            $qr = "SELECT * FROM binhluan,taikhoan
                                                WHERE binhluan.id = taikhoan.id
                                                AND  binhluan.maSP = '$idbl' AND binhluan.trangthaiBL = 1";
                            $query_lietke_binhluan = mysqli_query($con, $qr);

                            ?>
                            <form action="./php/comment.php" method="POST" onsubmit="return checkComment()">
                                <p><input type="hidden" value="<?php echo $idSP ?>" name="maSP_binhluan"></p>
                                <p><input type="hidden" value="<?php $uri = $_SERVER['REQUEST_URI'];
                                                                echo $uri; ?>" name="url"></p>
                                <div class="comment_tilte-user">
                                    <img src="./assets/img/avata1.jpg" alt="" class="header__navbar-user-img">
                                    <span class="header__navbar-user-name"><?php echo $email; ?></span>
                                    <input type="text" name="id_tk" value="<?php if ($_SESSION['id_tk']) {
                                                                                echo $_SESSION['id_tk'];
                                                                            } else {
                                                                                $_SESSION['id_tk'] = '';
                                                                                echo $_SESSION['id_tk'];
                        ...
                        <div class="comment_body">
                            <div class="comment_body-from">
                                <div class="comment_body-text">COMMENTS</div>

                                <?php foreach ($query_lietke_binhluan as $row) : ?>
                                    <div class="comment_body-formheader">

                                        <div class="comment_body-form-details">
                                            <img src="./assets/img/avata1.jpg" alt="" class="comment_body-user-img">
                                            <div class="comment_body-comment_of_user">
                                                <span class="header__navbar-user-name  "><?= $row["email"] ?></span>
                                                <div class="comment_body-content"><?= $row["binhluan"] ?></div>
                                                <div class="comment_body-comment_of_user-time">
                                                    <div class="comment_body-content-rep">Trả lời</div>
                                                    <div class="comment_body-content-time"><?= $row["thoigian"] ?></div>
                                                </div>
                                            </div>
                                        </div>
                                    </div> <?php endforeach; ?>
        ...
        <div class="grid">
            <div class="grid__row">
                ...
                <div class="grid__column-2-4">
                    ...
                    <ul class="footer-list">
                        <li class="footer-item">
                            <a href="https://www.facebook.com/yeon.dinh/about" class="footer-item__link">Giới thiệu</a>
                        </li>
                        <li class="footer-item">
                            ...
                            <div class="form__pay-customer-info">
                                <div class="form__pay-customer-info-default">
                                    <div class="form__pay-customer-name">
                                        <?php
                                        $sqlTK = "SELECT * FROM `khachhan` WHERE `emailKH` = '$email' LIMIT 1";
...
<div class="form__pay-bill-body-btn">
    ...
    <a href="./php/pay.php?idkh=<?php echo $idkh; ?>" class="form__pay-bill-body-btn1 btn btn--primary">Thanh toán</a>
        ...
        <div class="pay" id="showCommentNull" style="display: none">
            <div class="form__pay">
                <div class="form__pay-heading">
                    <span class="form__pay-heading-title">
                        <i class="form__pay-heading-title-icon fas fa-bell"></i>
