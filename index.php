         ...
         <header class="header">
             <div class="grid">
                 ...
                 <div class="header-with-search">
                     ...
                     <form action="search.php" method="POST" style="width:70%">
                         ...
                         <div class="select-input">
                             ...
                             <ul class="select-input__list">
                                 <li class="select-input__item">
                                     <a href="low-high.php" class="select-input__link">Giá: Thấp đến cao</a>
                                 </li>
                                 <li class="select-input__item">
                                     <a href="high-low.php" class="select-input__link">Giá: Cao đến thấp</a>
                                 </li>
                             </ul>
                         </div>
             ...
             <div class="grid__row">
                 <div class="grid__column-2-4">
                     ...
                     <ul class="footer-list">
                         ...
                         <li class="footer-item">
                             <a href="" class="footer-item__link">YDshop@gmail.com</a>
                         </li>
                         <li class="footer-item">
             ...
             <div class="auth-form" id="showModalregister" style="display: none">
                 <div class="auth-form__container">
                     ...
                     <form method="POST" action="./php/signup.php" onsubmit="return CheckValidate()">
                         ...
                         <div class="auth-form__group1">
                             <div class="auth-form__radio">

                                 <!-- <span class="auth-form__radio-text"> Giới tính:</span> -->

                                 <div class="auth-form__radio-choose-rules">
                                     <input type="radio" class="rules" id="age1" name="age" value="Nam">
                                     <label for="age1" class="radio-rules">Bạn đồng ý với điều khoản và chính sách bảo mật</label>
                                 </div>
                             </div>
                         </div>
             ...
             <div class="auth-form" id="showModalLogin" style="display: none">
                 <div class="auth-form__container">
                     ...
                     <form method="POST" action="./php/login.php">
                         <div class="auth-form__form">
                             <div class="auth-form__group">
                                 <input type="hidden" value="<?php $uri = $_SERVER['REQUEST_URI'];
                                                                echo $uri; ?>" name="url">
                     ...
                     <div class="contentcart__body">
                         ...
                         <div style="text-align: right; margin-right: 30px;">
                             ...
                             <span class="contentcart__products-btn" onclick="tb()">
                                 <a href="#" class="contentcart__products-btn-pay btn btn--primary" onclick="showModalPayinCart()">Đặt hàng</a>
 ...
 <?php
    ...
    ?>
         ...
         <!-- <div class="notification" id="showModalnotification"style ="display: block">
                    <div class="form_notification">
                        ...
                        <div class="notification_content">
                            <p class="notification_text">Vui lòng đăng nhập trước khi đặt hàng</p>
                        </div>
                    </div>
                </div> -->
     </div>
